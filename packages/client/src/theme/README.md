# Dynamic Theme System for @lemefy/client
...
```bash
npm install @lemefy/client
```

### 2. Wrap Your App with ThemeProvider

```tsx
import { ThemeProvider } from '@lemefy/client';
...
module.exports = {
  content: [
    ...
    './node_modules/@lemefy/client/dist/**/*.js',
  ],
  darkMode: ['class'],
  theme: {
    extend: {
...
```tsx
import { IThemeRGB } from '@lemefy/client';
...
```tsx
import { useTheme } from '@lemefy/client';
...
**After:**
```tsx
import { ThemeContext, ThemeProvider } from '@lemefy/client';
```
...
```tsx
import { ThemeProvider, defaultTheme, darkTheme } from '@lemefy/client';
...
This theme system is part of the @lemefy/client package. 