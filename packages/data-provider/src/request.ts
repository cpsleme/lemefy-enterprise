...
const AUTH_REDIRECT_STORAGE_KEY = 'lemefy.auth.redirect.startedAt';
...
type AuthRecoveryWindow = Window & {
  __lemefyAuthRecovery?: AuthRecoveryState;
};
...
const getAuthRecoveryState = (): AuthRecoveryState => {
  ...
  browserWindow.__lemefyAuthRecovery ??= {
    lastRedirectStartedAt: 0,
    refreshPromise: null,
  };
  return browserWindow.__lemefyAuthRecovery;
};
