...
export const finopsReport = (params: { projectId: string; periodStart: string; periodEnd: string }) =>
  `${lemefyRoot}/finops/report?projectId=${encodeURIComponent(params.projectId)}&periodStart=${encodeURIComponent(params.periodStart)}&periodEnd=${encodeURIComponent(params.periodEnd)}`;

export const finopsRecommendations = (projectId: string) =>
  `${lemefyRoot}/finops/recommendations?projectId=${encodeURIComponent(projectId)}`;

export const finopsCostByService = (projectId: string, periodStart: string, periodEnd: string) =>
  `${lemefyRoot}/finops/cost-by-service?projectId=${encodeURIComponent(projectId)}&periodStart=${encodeURIComponent(periodStart)}&periodEnd=${encodeURIComponent(periodEnd)}`;

export const governancePolicies = (standard?: string) => {
  const url = `${lemefyRoot}/governance/policies`;
  return standard ? `${url}?standard=${encodeURIComponent(standard)}` : url;
};

export const governancePolicy = (id: string) => `${lemefyRoot}/governance/policies/${encodeURIComponent(id)}`;

export const governanceCompliance = (policyId: string) =>
  `${lemefyRoot}/governance/compliance/${encodeURIComponent(policyId)}`;

export const governanceComplianceAll = `${lemefyRoot}/governance/compliance`;

export const governanceUpdateControl = (policyId: string, controlId: string) =>
  `${lemefyRoot}/governance/policies/${encodeURIComponent(policyId)}/controls/${encodeURIComponent(controlId)}`;

export const lemefyProjects = `${lemefyRoot}/projects`;

export const lemefyProject = (id: string) => `${lemefyRoot}/projects/${encodeURIComponent(id)}`;

export const lemefyProjectTasks = (projectId: string) =>
  `${lemefyRoot}/projects/${encodeURIComponent(projectId)}/tasks`;

export const lemefyTasks = `${lemefyRoot}/tasks`;

export const lemefyTask = (id: string) => `${lemefyRoot}/tasks/${encodeURIComponent(id)}`;

export const lemefyWorkflowsFlows = `${lemefyRoot}/workflows/flows`;

export const lemefyWorkflowFlow = (deploymentId: string) =>
  `${lemefyRoot}/workflows/flows/${encodeURIComponent(deploymentId)}`;

export const lemefyTriggerFlow = (deploymentId: string) =>
  `${lemefyRoot}/workflows/flows/${encodeURIComponent(deploymentId)}/trigger`;

export const lemefyRuns = `${lemefyRoot}/workflows/runs`;

export const lemefyRun = (runId: string) => `${lemefyRoot}/workflows/runs/${encodeURIComponent(runId)}`;

export const lemefyFlow = (flowId: string) => `${lemefyRoot}/workflows/flows/${encodeURIComponent(flowId)}`;

export const ragSearch = `${lemefyRoot}/rag/search`;

export const ragDocuments = `${lemefyRoot}/rag/documents`;

export const ragDocument = (id: string) => `${lemefyRoot}/rag/documents/${encodeURIComponent(id)}`;

export const doraMetrics = (team: string, periodStart: string, periodEnd: string) =>
  `${lemefyRoot}/metrics/dora?team=${encodeURIComponent(team)}&periodStart=${encodeURIComponent(periodStart)}&periodEnd=${encodeURIComponent(periodEnd)}`;

export const spaceMetrics = (team: string, period: string) =>
  `${lemefyRoot}/metrics/space?team=${encodeURIComponent(team)}&period=${encodeURIComponent(period)}`;
