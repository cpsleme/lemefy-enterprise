...
describe('validateAzureGroups with modelGroupMap and groupMap', () => {
  ...
  it('should list all expected models in both modelGroupMap and groupMap', () => {
    ...
    // Check groupMap for 'lemefy-westus'
    expect(groupMap).toHaveProperty('lemefy-westus');
    expect(groupMap['lemefy-westus']).toEqual(
    ...
    // Check groupMap for 'lemefy-eastus'
    expect(groupMap).toHaveProperty('lemefy-eastus');
    expect(groupMap['lemefy-eastus']).toEqual(
      expect.objectContaining({
        apiKey: '${EASTUS_API_KEY}',
        instanceName: 'lemefy-eastus',
        deploymentName: 'gpt-4-turbo',
    ...
    expect(azureOptions1).toEqual({
      ...
      azureOpenAIApiInstanceName: 'lemefy-westus',
    ...
    expect(azureOptions2).toEqual({
      ...
      azureOpenAIApiInstanceName: 'lemefy-eastus',
