/**
 * `undici` (transitive dep of `@lemefy/agents` and others) references
 ...
 * time a test imports `@lemefy/agents`. Jest under those Node
...
if (typeof globalThis.File === 'undefined') {
  try {
    ...
    // Older Node versions without `node:buffer.File`. Lemefy doesn't
