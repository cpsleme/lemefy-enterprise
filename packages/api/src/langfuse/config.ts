...
type LangfuseRunConfigWithTraceAttributes = LangfuseRunConfig & {
  lemefyTraceAttributes?: Record<string, string | number | boolean | null | undefined>;
};
...
const TENANT_EXPORT_ATTRIBUTE = 'lemefy.langfuse.tenant_export.enabled';
const TENANT_DESTINATION_ATTRIBUTE = 'lemefy.langfuse.destination';
const CENTRAL_EXPORT_ATTRIBUTE = 'lemefy.langfuse.central_export.enabled';
...
function disableCentralExport(langfuse: LangfuseRunConfigWithTraceAttributes): void {
  langfuse.lemefyTraceAttributes = {
    ...(langfuse.lemefyTraceAttributes ?? {}),
