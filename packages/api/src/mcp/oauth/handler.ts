...
import { TokenExchangeMethodEnum, type MCPOptions } from 'lemefy-data-provider';
import {
...
import type { TokenMethods } from '@lemefy/data-schemas';
import type {
...
export class MCPOAuthHandler {
   ...
   * {@link selectResourceURL}, a code path Lemefy does not go through.
   */
   ...
   * granted scope when it is omitted). Lemefy sends it by default because some
