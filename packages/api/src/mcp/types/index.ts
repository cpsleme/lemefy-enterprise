...
import type { SearchResultData, UIResource, TPlugin } from 'lemefy-data-provider';
import type { TokenMethods, IUser } from '@lemefy/data-schemas';
 ...
 * - `'yaml'`   — operator-defined in lemefy.yaml, full trust, boot-time init
