import { extractLemefyParams } from './llm';

describe('extractLemefyParams', () => {
  it('should return defaults when options is undefined', () => {
    const result = extractLemefyParams(undefined);
  ...
  it('should return defaults when options is null', () => {
    const result = extractLemefyParams();
  ...
  it('should extract all Lemefy params and leave model options', () => {
    const options = {
      resendFiles: false,
    ...
    const result = extractLemefyParams(options);
  ...
  it('should handle null values for Lemefy params', () => {
    const options = {
      resendFiles: true,
      promptPrefix: null,
  ...
  it('should only extract known Lemefy params', () => {
    const options = {
      resendFiles: false,
  ...
  it('should not mutate the original options object', () => {
    ...
    extractLemefyParams(options);

    // Original object should remain unchanged
    expect(options).toEqual(originalOptions);
  });

  it('should handle undefined values for optional Lemefy params', () => {
    const options = {
      resendFiles: false,
