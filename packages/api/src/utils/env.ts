import { extractEnvVariable } from 'lemefy-data-provider';
import type { MCPOptions } from 'lemefy-data-provider';
 ...
 *
 * NOTE: This is a Lemefy-specific encoding scheme to work around Fetch API limitations.
