 ...
 * Custom events prefixed with 'lemefy:' per Open Responses spec
 * @see https://openresponses.org/specification#extending-streaming-events
 * ============================================================================= */

/**
 * Attachment data for lemefy:attachment events
 */
...
/**
 * Emit lemefy:attachment event for file/image attachments
 * This is a Lemefy extension to the Open Responses streaming protocol.
