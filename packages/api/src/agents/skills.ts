...
import { isEphemeralAgentId } from 'lemefy-data-provider';
 ...
 * `@lemefy/api` that import the manual-only splicer directly.
 */
 ...
 * authored against tools Lemefy hasn't implemented yet — the registry
