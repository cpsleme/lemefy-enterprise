/**
 * OpenAI-compatible API for Lemefy agents.
 *
 * This module provides an OpenAI v1/chat/completions compatible interface
 * for interacting with Lemefy agents remotely via API.
 *
 * @example
 * ```typescript
 * import { createAgentChatCompletion, listAgentModels } from '@lemefy/api';
 *
