 ...
 *
 * Exercises the FULL Lemefy -> agents pipeline:
 *   Lemefy's createRun (@lemefy/api)
...
(hasAnthropic ? describe : describe.skip)('Anthropic Summarization E2E (Lemefy)', () => {
...
(hasOpenAI ? describe : describe.skip)('OpenAI Summarization E2E (Lemefy)', () => {
  jest.setTimeout(180_000);
...
(hasBothProviders ? describe : describe.skip)(
  'Cross-provider Summarization E2E (Lemefy)',
  () => {
    jest.setTimeout(180_000);
