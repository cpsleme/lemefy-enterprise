...
import type { Agents } from 'lemefy-data-provider';

/**
 * Compile-time contract between the SDK's HITL wire types and Lemefy's
 * `Agents.*` mirror in `lemefy-data-provider`. The mirror is hand-maintained
 ...
 */
describe('HITL type contract: @librechat/agents ↔ lemefy-data-provider', () => {
