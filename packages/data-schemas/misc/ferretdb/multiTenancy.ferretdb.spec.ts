 ...
 *
 * Validates whether FerretDB can handle Lemefy's multi-tenancy model
 ...
 *   PG_CONTAINER     — Docker container name for psql (default: lemefy-ferretdb-postgres-1)
...
const PG_CONTAINER = process.env.PG_CONTAINER || 'lemefy-ferretdb-postgres-1';
...
/** All 29 Lemefy schemas by Mongoose model name */
