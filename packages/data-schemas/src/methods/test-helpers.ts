/**
 * Inlined utility functions previously imported from @lemefy/api.
 ...
 *
 * Inlined from @lemefy/api findMatchingPattern
 */
 ...
 *
 * Inlined from @lemefy/api matchModelName (simplified for test use)
 */
