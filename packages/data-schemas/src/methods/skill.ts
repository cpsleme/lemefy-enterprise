...
import type { CodeEnvRef } from 'lemefy-data-provider';
...
/**
 * Slash-command names that collide with Lemefy / Claude Code CLI commands.
 ...
 * spec plus the fields Lemefy needs to pass through (`name`/`description`
...
export function createSkillMethods(
   ...
   * set), and Lemefy does not currently require that deployment shape. In
