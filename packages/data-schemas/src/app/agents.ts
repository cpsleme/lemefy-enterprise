import { EModelEndpoint, agentsEndpointSchema } from 'lemefy-data-provider';
import type { TCustomConfig, TAgentsEndpoint } from 'lemefy-data-provider';

/**
 * Sets up the Agents configuration from the config (`lemefy.yaml`) file.
