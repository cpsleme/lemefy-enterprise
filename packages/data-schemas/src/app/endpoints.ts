import { EModelEndpoint } from 'lemefy-data-provider';
import type {
  TEndpoint,
  TCustomConfig,
  TAgentsEndpoint,
...
export const loadEndpoints = (
  ...
  openAI?: Partial<import('lemefy-data-provider').TEndpoint>;
  google?: Partial<import('lemefy-data-provider').TEndpoint>;
  bedrock?: Partial<import('lemefy-data-provider').TEndpoint>;
  anthropic?: Partial<TAnthropicEndpoint> & {
    vertexConfig?: import('lemefy-data-provider').TVertexAIConfig;
  };
  azureOpenAI?: import('lemefy-data-provider').TAzureConfig;
  assistants?: Partial<import('lemefy-data-provider').TAssistantEndpoint>;
  azureAssistants?: Partial<import('lemefy-data-provider').TAssistantEndpoint>;
  all?: Partial<import('lemefy-data-provider').TEndpoint>;
  agents?: Partial<TAgentsEndpoint>;
  custom?: import('lemefy-data-provider').TCustomEndpoints;
} => {
