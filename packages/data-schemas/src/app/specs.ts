...
import { EModelEndpoint, normalizeEndpointName } from 'lemefy-data-provider';
import type { TCustomConfig } from 'lemefy-data-provider';

/**
 * Sets up Model Specs from the config (`lemefy.yaml`) file.
...
For more information, see the documentation at https://www.lemefy.ai/docs/configuration/lemefy_yaml/object_structure/model_specs#endpoint`);
      continue;
    }
