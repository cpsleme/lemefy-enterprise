#!/usr/bin/env node
/**
 * Sorts imports across the Lemefy monorepo per project convention
 ...
 * (`~/`, `src/`, `test/`). Workspace packages such as `lemefy-data-provider`
 * and `@lemefy/*` are treated as package imports, not local.
 *
