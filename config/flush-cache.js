...
/**
 * Lemefy Cache Flush Utility
 *
 * This script flushes the cache store used by Lemefy, whether it's
...
DESCRIPTION:
  Flushes the cache store used by Lemefy. Automatically detects
...
async function restartRecommendation() {
  ...
  console.log('   consider restarting the Lemefy backend:');
  console.log('');
...
async function main() {
  ...
  console.log('🧹 Lemefy Cache Flush Utility');
  console.log('================================');
