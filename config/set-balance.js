...
const { getBalanceConfig } = require('@lemefy/api');
const { User, Balance } = require('@lemefy/data-schemas').createModels(mongoose);
...
(async () => {
  ...
  if (!balanceConfig?.enabled) {
    console.red('Error: Balance is not enabled. Use lemefy.yaml to enable it');
    silentExit(1);
  }
