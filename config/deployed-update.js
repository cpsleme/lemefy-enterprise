...
(async () => {
  ...
  console.purple('Removing all tags for Lemefy `deployed` images...');
  const repositories = ['registry.lemefy.ai/danny-avila/lemefy-dev-api', 'lemefy-client'];
  ...
  console.purple('Pulling latest Lemefy images...');
