...
const { runAsSystem } = require('@lemefy/data-schemas');
const { User } = require('@lemefy/data-schemas').createModels(mongoose);
const { countUsers } = require('@lemefy/data-schemas').createMethods(mongoose);
