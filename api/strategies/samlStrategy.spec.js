...
const { FileSources } = require('lemefy-data-provider');
const { findUser } = require('~/models');
const { resolveAppConfigForUser } = require('@lemefy/api');
...
-----END CERTIFICATE-----
  ...
  it('should block login when email exists with different provider', async () => {
    ...
    expect(result.details.message).toBe(require('lemefy-data-provider').ErrorTypes.AUTH_FAILED);
  });
