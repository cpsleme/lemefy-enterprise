...
jest.mock('@lemefy/api', () => require(MOCKS).api());
jest.mock('@lemefy/data-schemas', () => require(MOCKS).dataSchemas());
jest.mock('lemefy-data-provider', () => require(MOCKS).dataProvider());
