...
const { createModels, createMethods } = require('@lemefy/data-schemas');
const { MongoMemoryServer } = require('mongodb-memory-server');
const { SystemRoles, PrincipalType } = require('lemefy-data-provider');
const { SystemCapabilities } = require('@lemefy/data-schemas');

jest.mock('@lemefy/data-schemas', () => ({
  ...jest.requireActual('@lemefy/data-schemas'),
  getTransactionSupport: jest.fn().mockResolvedValue(false),
  createModels: jest.requireActual('@lemefy/data-schemas').createModels,
  createMethods: jest.requireActual('@lemefy/data-schemas').createMethods,
}));
