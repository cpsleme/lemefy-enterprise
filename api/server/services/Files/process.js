...
const { logger, runAsSystem } = require('@lemefy/data-schemas');
const {
  sanitizeFilename,
  parseText,
  processAudioFile,
 ...
 * @param {import('@lemefy/api').UploadSseStream | null} [params.sseStream] - Active upload SSE stream, if enabled.
 ...
 * @param {RunClient} params.client - The Lemefy client instance: either refers to `openai` or `streamRunManager`.
 * @param {string} params.file_id - The ID of the file to retrieve.
