...
const { logger, getTenantId } = require('@lemefy/data-schemas');
 ...
 * @returns {Promise<Record<string, import('@lemefy/api').ParsedServerConfig>>}
 */
 ...
 * `assertResolvedRuntimeConfigAllowed` in `@lemefy/api`, whose resolution
 ...
 * @param {import('@lemefy/api').RequestScopedMCPConnectionStore} [params.requestScopedConnections]
 * @param {import('@lemefy/api').ParsedServerConfig} [params.serverConfig] - Used to bypass reconnect throttling for request-scoped servers.
 ...
 * @param {AbortSignal} [params.signal]
 * @param {string | null} [params.streamId] - The stream ID for resumable mode.
 * @param {import('@lemefy/api').ParsedServerConfig} [params.config]
 * @param {import('@lemefy/api').RequestBody} [params.requestBody]
 * @param {import('@lemefy/api').RequestScopedMCPConnectionStore} [params.requestScopedConnections]
 * @param {Record<string, Record<string, string>>} [params.userMCPAuthMap]
 * @returns { Promise<Array<typeof tool | { _call: (toolInput: Object | string) => unknown}>> } An object with `_call` method to execute the tool input.
 */
...
async function getMCPSetupData(userId, options = {}) {
  ...
  const mcpManager = getMCPManager(userId);
  /** @type {Map<string, import('@lemefy/api').MCPConnection>} */
 ...
 * @param {string} userId - The user ID
 * @param {string} serverName - The server name
 * @param {import('@lemefy/api').ParsedServerConfig} config - The server configuration
 * @param {Map<string, import('@lemefy/api').MCPConnection>} appConnections - App-level connections
 * @param {Map<string, import('@lemefy/api').MCPConnection>} userConnections - User-level connections
