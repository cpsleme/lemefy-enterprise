...
const { loadYaml } = require('@lemefy/api');
...
const defaultConfigPath = path.resolve(projectRoot, 'lemefy.yaml');
...
https://www.lemefy.ai/docs/configuration/stt_tts`);
    }
