...
const { countTokens } = require('@lemefy/api');
const { escapeRegExp } = require('@lemefy/data-schemas');
const {
  Constants,
  ContentTypes,
  AnnotationTypes,
 ...
 * @param {import('lemefy-data-provider').TFile[]} [params.files] - Optional. List of Attached File Objects.
...
/**
 * Records Lemefy messageId to all response messages' metadata
 *
 * @param {Object} params - The parameters for initializing a thread.
 * @param {OpenAIClient} params.openai - The OpenAI client instance.
 * @param {string} params.thread_id - Response thread ID.
 * @param {string} params.messageId - The response `messageId` generated by Lemefy.
...
/**
 * Synchronizes Lemefy messages to Thread Messages.
 * Updates the Lemefy DB with any missing Thread Messages and
 ...
 * @param {TMessage[]} params.dbMessages - The Lemefy DB messages.
 ...
 * @param {OpenAIClient} params.openai - The OpenAI client instance.
 * @param {string} params.endpoint - The current endpoint.
 * @param {string} [params.latestMessageId] - Optional: The latest message ID from Lemefy.
 * @param {string} params.thread_id - Response thread ID.
 * @param {string} params.run_id - Response Run ID.
 * @param {string} params.conversationId - Lemefy conversation ID.
 * @return {Promise<TMessage[]>} A promise that resolves to the updated messages
 */
 ...
 * @param {OpenAIClient} params.openai - The OpenAI client instance.
 * @param {RunClient} params.client - The Lemefy client that manages the run: either refers to `OpenAI` or `StreamRunManager`.
