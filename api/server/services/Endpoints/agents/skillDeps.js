 ...
 * @param {Record<string, import('@lemefy/api').LCAvailableTools>} [params.config.mcpAvailableTools]
 * @param {import('@lemefy/api').RequestScopedMCPConnectionStore} [params.config.requestScopedConnections]
 * @returns {object}
 */
