 ...
 * Handles MCP-specific tool endpoints, decoupled from regular Lemefy tools
 *
 * @import { MCPServerRegistry } from '@lemefy/api'
 * @import { MCPServerDocument } from 'lemefy-data-provider'
 */
const { logger, SystemCapabilities } = require('@lemefy/data-schemas');
const {
  checkAccess,
  isUserSourced,
  MCPErrorCodes,
