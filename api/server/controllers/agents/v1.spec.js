...
const { agentSchema, aclEntrySchema, fileSchema, userSchema } = require('@lemefy/data-schemas');
const {
  FileSources,
  PermissionBits,
  PrincipalModel,
...
const { mergeDeploymentSkillIds, refreshS3Url } = require('@lemefy/api');

/**
 * @type {import('mongoose').Model<import('@lemefy/data-schemas').IAgent>}
 */
let Agent;
let AclEntry;
let User;
