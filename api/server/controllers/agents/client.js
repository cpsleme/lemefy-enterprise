...
class AgentClient extends BaseClient {
  constructor(options = {}) {
     ...
     *  @type {{ latest: import('lemefy-data-provider').TContextUsageEvent | null } | undefined} */
     ...
     *  @type {Array<import('lemefy-data-provider').TTokenUsageEvent> | undefined} */
     ...
     *  @type {Map<string, import('@lemefy/api').ToolInputValidationError> | undefined} */
     ...
     *  @type {import('@lemefy/api').SteerOffsetState} */
   ...
   * @param {import('@lemefy/api').SteerQueueItem} item
   */
  ...
  async useMemory() {
    ...
    /** @type {import('@lemefy/api').MemoryConfig} */
    const config = {
   ...
   *   contextUsage?: import('lemefy-data-provider').TContextUsageEvent,
   *   usage?: import('lemefy-data-provider').TResponseUsage,
   * } | undefined}
   */
   ...
   * @returns {import('@lemefy/api').EndpointTokenConfig | undefined}
   */
