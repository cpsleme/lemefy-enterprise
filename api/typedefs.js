 ...
 * @typedef {import('lemefy-data-provider').Agents.ToolCallDelta} AgentToolCallDelta
 * @memberof typedefs
 */

/**
 * @exports ToolCallChunk
 * @typedef {import('lemefy-data-provider').Agents.ToolCallChunk} ToolCallChunk
 * @memberof typedefs
 */

/**
 * @exports MessageContentImageUrl
 * @typedef {import('lemefy-data-provider').Agents.MessageContentImageUrl} MessageContentImageUrl
 * @memberof typedefs
 */
...
/**
 * @exports ValidSource
 * @typedef {import('lemefy-data-provider').ValidSource} ValidSource
 * @memberof typedefs
 */
...
/**
 * @exports TPrompt
 * @typedef {import('lemefy-data-provider').TPrompt} TPrompt
 * @memberof typedefs
 */

/**
 * @exports TPromptGroup
 * @typedef {import('lemefy-data-provider').TPromptGroup} TPromptGroup
 * @memberof typedefs
 */

/**
 * @exports TCreatePrompt
 * @typedef {import('lemefy-data-provider').TCreatePrompt} TCreatePrompt
 * @memberof typedefs
 */

/**
 * @exports TCreatePromptRecord
 * @typedef {import('lemefy-data-provider').TCreatePromptRecord} TCreatePromptRecord
 * @memberof typedefs
 */
/**
 * @exports TCreatePromptResponse
 * @typedef {import('lemefy-data-provider').TCreatePromptResponse} TCreatePromptResponse
 * @memberof typedefs
 */
/**
 * @exports TUpdatePromptGroupResponse
 * @typedef {import('lemefy-data-provider').TUpdatePromptGroupResponse} TUpdatePromptGroupResponse
 * @memberof typedefs
 */

/**
 * @exports TPromptGroupsWithFilterRequest
 * @typedef {import('lemefy-data-provider').TPromptGroupsWithFilterRequest } TPromptGroupsWithFilterRequest
 * @memberof typedefs
 */

/**
 * @exports PromptGroupListResponse
 * @typedef {import('lemefy-data-provider').PromptGroupListResponse } PromptGroupListResponse
 * @memberof typedefs
 */

/**
 * @exports TGetCategoriesResponse
 * @typedef {import('lemefy-data-provider').TGetCategoriesResponse } TGetCategoriesResponse
 * @memberof typedefs
 */

/**
 * @exports TGetRandomPromptsResponse
 * @typedef {import('lemefy-data-provider').TGetRandomPromptsResponse } TGetRandomPromptsResponse
 * @memberof typedefs
 */

/**
 * @exports TGetRandomPromptsRequest
 * @typedef {import('lemefy-data-provider').TGetRandomPromptsRequest } TGetRandomPromptsRequest
 * @memberof typedefs
 */

/**
 * @exports TUpdatePromptGroupPayload
 * @typedef {import('lemefy-data-provider').TUpdatePromptGroupPayload } TUpdatePromptGroupPayload
 * @memberof typedefs
 */

/**
 * @exports TDeletePromptVariables
 * @typedef {import('lemefy-data-provider').TDeletePromptVariables } TDeletePromptVariables
 * @memberof typedefs
 */

/**
 * @exports TDeletePromptResponse
 * @typedef {import('lemefy-data-provider').TDeletePromptResponse } TDeletePromptResponse
 * @memberof typedefs
 */
...
/**
 * @exports TRole
 * @typedef {import('lemefy-data-provider').TRole } TRole
 * @memberof typedefs
 */

/**
 * @exports PermissionTypes
 * @typedef {import('lemefy-data-provider').PermissionTypes } PermissionTypes
 * @memberof typedefs
 */

/**
 * @exports Permissions
 * @typedef {import('lemefy-data-provider').Permissions } Permissions
 * @memberof typedefs
 */
...
/**
 * @exports Assistant
 * @typedef {import('lemefy-data-provider').Assistant} Assistant
 * @memberof typedefs
 */

/**
 * @exports AssistantDocument
 * @typedef {import('lemefy-data-provider').AssistantDocument} AssistantDocument
 * @memberof typedefs
 */

/**
 * @exports OpenAIFile
 * @typedef {import('lemefy-data-provider').File} OpenAIFile
 * @memberof typedefs
 */

/**
 * @exports TConfig
 * @typedef {import('lemefy-data-provider').TConfig} TConfig
 * @memberof typedefs
 */

/**
 * @exports TPayload
 * @typedef {import('lemefy-data-provider').TPayload} TPayload
 * @memberof typedefs
 */

/**
 * @exports TAzureModelConfig
 * @typedef {import('lemefy-data-provider').TAzureModelConfig} TAzureModelConfig
 * @memberof typedefs
 */

/**
 * @exports TAzureGroup
 * @typedef {import('lemefy-data-provider').TAzureGroup} TAzureGroup
 * @memberof typedefs
 */

/**
 * @exports TAzureGroups
 * @typedef {import('lemefy-data-provider').TAzureGroups} TAzureGroups
 * @memberof typedefs
 */

/**
 * @exports TAzureModelGroupMap
 * @typedef {import('lemefy-data-provider').TAzureModelGroupMap} TAzureModelGroupMap
 * @memberof typedefs
 */
/**
 * @exports TAzureGroupMap
 * @typedef {import('lemefy-data-provider').TAzureGroupMap} TAzureGroupMap
 * @memberof typedefs
 */

/**
 * @exports TAzureConfig
 * @typedef {import('lemefy-data-provider').TAzureConfig} TAzureConfig
 * @memberof typedefs
 */

/**
 * @exports TModelsConfig
 * @typedef {import('lemefy-data-provider').TModelsConfig} TModelsConfig
 * @memberof typedefs
 */

/**
 * @exports TStartupConfig
 * @typedef {import('lemefy-data-provider').TStartupConfig} TStartupConfig
 * @memberof typedefs
 */

/**
 * @exports TConfigDefaults
 * @typedef {import('lemefy-data-provider').TConfigDefaults} TConfigDefaults
 * @memberof typedefs
 */

/**
 * @exports TPlugin
 * @typedef {import('lemefy-data-provider').TPlugin} TPlugin
 * @memberof typedefs
 */

/**
 * @exports TAzureConfigValidationResult
 * @typedef {import('lemefy-data-provider').TAzureConfigValidationResult} TAzureConfigValidationResult
 * @memberof typedefs
 */

/**
 * @exports EImageOutputType
 * @typedef {import('lemefy-data-provider').EImageOutputType} EImageOutputType
 * @memberof typedefs
 */

/**
 * @exports TCustomConfig
 * @typedef {import('lemefy-data-provider').TCustomConfig} TCustomConfig
 * @memberof typedefs
 */

/**
 * @exports TProviderSchema
 * @typedef {import('lemefy-data-provider').TProviderSchema} TProviderSchema
 * @memberof typedefs
 */

/**
 * @exports TBaseEndpoint
 * @typedef {import('lemefy-data-provider').TBaseEndpoint} TBaseEndpoint
 * @memberof typedefs
 */

/**
 * @exports TEndpoint
 * @typedef {import('lemefy-data-provider').TEndpoint} TEndpoint
 * @memberof typedefs
 */

/**
 * @exports TEndpointsConfig
 * @typedef {import('lemefy-data-provider').TEndpointsConfig} TEndpointsConfig
 * @memberof typedefs
 */

/**
 * @exports TMessage
 * @typedef {import('lemefy-data-provider').TMessage} TMessage
 * @memberof typedefs
 */

/**
 * @exports TConversation
 * @typedef {import('lemefy-data-provider').TConversation} TConversation
 * @memberof typedefs
 */

/**
 * @exports TModelSpec
 * @typedef {import('lemefy-data-provider').TModelSpec} TModelSpec
 * @memberof typedefs
 */
...
/**
 * @exports FileSources
 * @typedef {import('lemefy-data-provider').FileSources} FileSources
 * @memberof typedefs
 */
...
/**
 * @exports ImageFile
 * @typedef {import('lemefy-data-provider').ImageFile} ImageFile
 * @memberof typedefs
 */

/**
 * @exports TMessageContentParts
 * @typedef {import('lemefy-data-provider').TMessageContentParts} TMessageContentParts
 * @memberof typedefs
 */

/**
 * @exports StreamContentData
 * @typedef {import('lemefy-data-provider').StreamContentData} StreamContentData
 * @memberof typedefs
 */

/**
 * @exports ActionRequest
 * @typedef {import('lemefy-data-provider').ActionRequest} ActionRequest
 * @memberof typedefs
 */

/**
 * @exports Action
 * @typedef {import('lemefy-data-provider').Action} Action
 * @memberof typedefs
 */

/**
 * @exports ActionMetadata
 * @typedef {import('lemefy-data-provider').ActionMetadata} ActionMetadata
 * @memberof typedefs
 */

/**
 * @exports ActionAuth
 * @typedef {import('lemefy-data-provider').ActionAuth} ActionAuth
 * @memberof typedefs
 */

/**
 * @exports DeleteFilesBody
 * @typedef {import('lemefy-data-provider').DeleteFilesBody} DeleteFilesBody
 * @memberof typedefs
 */
...
/**
 * @exports MongoFile
 * @typedef {import('@lemefy/data-schemas').IMongoFile} MongoFile
 * @memberof typedefs
 */

/**
 * @exports ISession
 * @typedef {import('@lemefy/data-schemas').ISession} ISession
 * @memberof typedefs
 */

/**
 * @exports IBalance
 * @typedef {import('@lemefy/data-schemas').IBalance} IBalance
 * @memberof typedefs
 */

/**
 * @exports IUser
 * @typedef {import('@lemefy/data-schemas').IUser} IUser
 * @memberof typedefs
 */

/**
 * @exports IPluginAuth
 * @typedef {import('@lemefy/data-schemas').IPluginAuth} IPluginAuth
 * @memberof typedefs
 */

/**
 * @exports IRole
 * @typedef {import('@lemefy/data-schemas').IRole} IRole
 * @memberof typedefs
 */
 ...
 * @typedef {import('lemefy-data-provider').EModelEndpoint} EModelEndpoint
 * @memberof typedefs
 */

/**
 * @exports TEndpointOption
 * @typedef {import('lemefy-data-provider').TEndpointOption} TEndpointOption
 * @memberof typedefs
 */

/**
 * @exports TAttachment
 * @typedef {import('lemefy-data-provider').TAttachment} TAttachment
 * @memberof typedefs
 */

/**
 * @exports AssistantCreateParams
 * @typedef {import('lemefy-data-provider').AssistantCreateParams} AssistantCreateParams
 * @memberof typedefs
 */

/**
 * @exports AssistantUpdateParams
 * @typedef {import('lemefy-data-provider').AssistantUpdateParams} AssistantUpdateParams
 * @memberof typedefs
 */

/**
 * @exports AssistantListParams
 * @typedef {import('lemefy-data-provider').AssistantListParams} AssistantListParams
 * @memberof typedefs
 */

/**
 * @exports AssistantListResponse
 * @typedef {import('lemefy-data-provider').AssistantListResponse} AssistantListResponse
 * @memberof typedefs
 */

/**
 * @exports ContentPart
 * @typedef {import('lemefy-data-provider').ContentPart} ContentPart
 * @memberof typedefs
 */

/**
 * @exports StepTypes
 * @typedef {import('lemefy-data-provider').StepTypes} StepTypes
 * @memberof typedefs
 */

/**
 * @exports TContentData
 * @typedef {import('lemefy-data-provider').TContentData} TContentData
 * @memberof typedefs
 */
 ...
 * @typedef {import('lemefy-data-provider').PartMetadata} PartMetadata
 * @memberof typedefs
 */
 ...
 * @typedef {import('lemefy-data-provider').TAssistantEndpoint} TAssistantEndpoint
 * @memberof typedefs
 */

/**
 * @exports TAgentsEndpoint
 * @typedef {import('lemefy-data-provider').TAgentsEndpoint} TAgentsEndpoint
 * @memberof typedefs
 */

/**
 * @exports Agent
 * @typedef {import('lemefy-data-provider').Agent} Agent
 * @memberof typedefs
 */

/**
 * @exports TEphemeralAgent
 * @typedef {import('lemefy-data-provider').TEphemeralAgent} TEphemeralAgent
 * @memberof typedefs
 */

/**
 * @exports TWebSearchKeys
 * @typedef {import('@lemefy/data-schemas').TWebSearchKeys} TWebSearchKeys
 * @memberof typedefs
 */

/**
 * @exports AgentToolResources
 * @typedef {import('lemefy-data-provider').AgentToolResources} AgentToolResources
 * @memberof typedefs
 */

/**
 * @exports AgentCreateParams
 * @typedef {import('lemefy-data-provider').AgentCreateParams} AgentCreateParams
 * @memberof typedefs
 */

/**
 * @exports AgentUpdateParams
 * @typedef {import('lemefy-data-provider').AgentUpdateParams} AgentUpdateParams
 * @memberof typedefs
 */

/**
 * @exports AgentListParams
 * @typedef {import('lemefy-data-provider').AgentListParams} AgentListParams
 * @memberof typedefs
 */

/**
 * @exports AgentListResponse
 * @typedef {import('lemefy-data-provider').AgentListResponse} AgentListResponse
 * @memberof typedefs
 */
 ...
 * @typedef {import('lemefy-data-provider').TUpdateResourcePermissionsRequest} TUpdateResourcePermissionsRequest
 * @memberof typedefs
 */

/**
 * @exports TUpdateResourcePermissionsResponse
 * @typedef {import('lemefy-data-provider').TUpdateResourcePermissionsResponse} TUpdateResourcePermissionsResponse
 * @memberof typedefs
 */

/**
 * @exports AppConfig
 * @typedef {import('@lemefy/data-schemas').AppConfig} AppConfig
 * @memberof typedefs
 */

/**
 * @exports JsonSchemaType
 * @typedef {import('@lemefy/data-schemas').JsonSchemaType} JsonSchemaType
 * @memberof typedefs
 */

/**
 * @exports MCPServers
 * @typedef {import('@lemefy/api').MCPServers} MCPServers
 * @memberof typedefs
 */
...
/**
 * @exports MCPManager
 * @typedef {import('@lemefy/api').MCPManager} MCPManager
 * @memberof typedefs
 */

/**
 * @exports MCPConnection
 * @typedef {import('@lemefy/api').MCPConnection} MCPConnection
 * @memberof typedefs
 */

/**
 * @exports LCFunctionTool
 * @typedef {import('@lemefy/api').LCFunctionTool} LCFunctionTool
 * @memberof typedefs
 */

/**
 * @exports FlowStateManager
 * @typedef {import('@lemefy/api').FlowStateManager} FlowStateManager
 * @memberof typedefs
 */

/**
 * @exports LCAvailableTools
 * @typedef {import('@lemefy/api').LCAvailableTools} LCAvailableTools
 * @memberof typedefs
 */

/**
 * @exports LCTool
 * @typedef {import('@lemefy/api').LCTool} LCTool
 * @memberof typedefs
 */

/**
 * @exports FormattedContent
 * @typedef {import('@lemefy/api').FormattedContent} FormattedContent
 * @memberof typedefs
 */
 ...
 * @typedef {import('@lemefy/data-schemas').FunctionTool} FunctionTool
 * @memberof typedefs
 */
 ...
 * @property {string} messageId - The ID of the message (from Lemefy).
 ...
 * @typedef {import('lemefy-data-provider').TForkConvoResponse} TForkConvoResponse
 * @memberof typedefs
 */

/**
 * @exports TForkConvoRequest
 * @typedef {import('lemefy-data-provider').TForkConvoRequest} TForkConvoRequest
 * @memberof typedefs
 */
