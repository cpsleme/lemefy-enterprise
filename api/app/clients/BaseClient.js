...
class BaseClient {
  constructor(apiKey, options = {}) {
    ...
    /** @type {import('lemefy-data-provider').VisionModes | undefined} */
    this.visionMode;
    /** @type {import('lemefy-data-provider').FileConfig | undefined} */
    this._mergedFileConfig;
    /** @type {import('lemefy-data-provider').EndpointFileConfig | undefined} */
