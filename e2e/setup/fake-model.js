/**
 * In-process fake LLM for credential-free e2e tests. Loaded by `@lemefy/api`'s
...
const SKILL_DESCRIPTION =
  'Use this skill to verify Lemefy skill file authoring in mock end-to-end tests.';
const EDITED_SKILL_DESCRIPTION =
  'Use this edited skill to verify Lemefy skill file authoring in mock end-to-end tests.';
...
/** @type {import('@lemefy/api').TestRunHook} */
