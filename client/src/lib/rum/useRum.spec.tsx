...
describe('useRum', () => {
    ...
    mockUseGetStartupConfig.mockReturnValue({
      data: {
        rum: {
          ...
          serviceName: 'lemefy-web',
          authMode: 'publicToken',
          publicToken: 'public-token',
          tracePropagationTargets: ['https://lemefy.example.com'],
        },
      },
    });
  ...
  it('initializes proxy RUM with the Lemefy bearer token for same-origin ingest', async () => {
