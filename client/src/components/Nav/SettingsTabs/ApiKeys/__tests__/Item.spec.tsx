...
import { useDeleteAgentApiKeyMutation } from 'lemefy-data-provider/react-query';
import type { TAgentApiKeyListItem } from 'lemefy-data-provider';
import { render, fireEvent } from 'test/layout-test-utils';
import Item from '../Item';

jest.mock('lemefy-data-provider/react-query', () => ({
  ...jest.requireActual('lemefy-data-provider/react-query'),
