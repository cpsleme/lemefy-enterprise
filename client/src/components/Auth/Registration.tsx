...
import { ThemeContext, SecretInput, Spinner, Button, isDark } from '@lemefy/client';
import { useNavigate, useOutletContext, useLocation } from 'react-router-dom';
import { useRegisterUserMutation } from 'lemefy-data-provider/react-query';
import { loginPage } from 'lemefy-data-provider';
import type { TRegisterUser, TError } from 'lemefy-data-provider';
