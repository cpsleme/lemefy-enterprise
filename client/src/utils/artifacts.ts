...
import { excelMimeTypes, shadcnComponents } from 'lemefy-data-provider';
import type {
  SandpackProviderProps,
  SandpackPredefinedTemplate,
} from '@codesandbox/sandpack-react';
import type { TStartupConfig, TAttachment, TFile } from 'lemefy-data-provider';
...
const artifactFilename = {
  ...
  'application/vnd.lemefy.docx-preview': 'index.html',
  'application/vnd.lemefy.spreadsheet-preview': 'index.html',
  'application/vnd.lemefy.presentation-preview': 'index.html',
...
> = {
  ...
  'application/vnd.lemefy.docx-preview': 'static',
  'application/vnd.lemefy.spreadsheet-preview': 'static',
  'application/vnd.lemefy.presentation-preview': 'static',
  default: 'static',
  // 'css': 'css',
  // 'javascript': 'js',
  // 'typescript': 'ts',
...
> = {
  ...
  'application/vnd.lemefy.docx-preview': {},
  'application/vnd.lemefy.spreadsheet-preview': {},
  'application/vnd.lemefy.presentation-preview': {},
...
export const TOOL_ARTIFACT_TYPES = {
   ...
   * `index.html` slot. The values are synthetic Lemefy-internal MIMEs
  ...
  DOCX: 'application/vnd.lemefy.docx-preview',
  SPREADSHEET: 'application/vnd.lemefy.spreadsheet-preview',
  PRESENTATION: 'application/vnd.lemefy.presentation-preview',
} as const;
